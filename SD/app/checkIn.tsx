...
import { Text, View, SafeAreaView, FlatList, TouchableOpacity, Modal, Keyboard, KeyboardAvoidingView, TouchableWithoutFeedback, Platform } from "react-native";
          ...
          <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? "padding" : undefined} style={{ backgroundColor: 'azure', flex: 1 }}>
              ...
              ? 
                ...
                ? 
                  <MoodGrid curDate={curDate} selectedActivityName={activityName} selectedActivityUnit={selectedActivityUnit} selectedActivityText={String(selectedActivityVal)} setSelectedActivityText={setSelectedActivityText} onSave={handleSave} />
                : 
                  <>
