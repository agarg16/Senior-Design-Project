  ...
  return (
    <View style={modalStyles.assessmentContainer}>
      <View style={modalStyles.rangeSelector}>
        ...
        >
          <Text style={selectedRange === 'week' ? modalStyles.selectedRangeText : modalStyles.rangeButtonText}>Last Week</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={selectedRange === 'month' ? modalStyles.selectedRangeText : modalStyles.rangeButtonText}>Last Month</Text>
        </TouchableOpacity>
      </View>
